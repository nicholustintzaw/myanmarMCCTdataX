...
create_anc <- function(df, x, y, status) {
  ...
  age <- floor(as.numeric(lubridate::mdy(z$intrv_date) -  lubridate::mdy(z$hh_mem_dob)) / 365.25)
  ...
  if(status == "past") {
    z <- z[as.integer(z$hh_mem_pregnow) == 0 & !is.na(z$hh_mem_pregnow) & as.integer(z$hh_mem_u5num) > 0 & !is.na(z$hh_mem_u5num), ]
  }
...
recode_provider_specialist <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    specialist.home <- bbw::recode(var = specialist.where, recodes = "1=1;NA=NA;else=0")
    specialist.gov <- bbw::recode(var = specialist.where, recodes = "2=1;NA=NA;else=0")
    specialist.private <- bbw::recode(var = specialist.where, recodes = "3=1;NA=NA;else=0")
    specialist.srhc <- bbw::recode(var = specialist.where, recodes = "4=1;NA=NA;else=0")
    specialist.village <- bbw::recode(var = specialist.where, recodes = "5=1;NA=NA;else=0")
    specialist.eho <- bbw::recode(var = specialist.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    specialist.dry <- as.integer(df$ancnow_pdoc_dist_dry)
    specialist.dry.lt15 <- bbw::recode(var = specialist.dry, recode = "1=1;NA=NA;else=0")
    specialist.dry.gteq15lt60 <- bbw::recode(var = specialist.dry, recode = "2=1;NA=NA;else=0")
    specialist.dry.gteq60lt120 <- bbw::recode(var = specialist.dry, recode = "3=1;NA=NA;else=0")
    specialist.dry.gteq120lt360 <- bbw::recode(var = specialist.dry, recode = "4=1;NA=NA;else=0")
    specialist.dry.gteq360lt720 <- bbw::recode(var = specialist.dry, recode = "5=1;NA=NA;else=0")
    specialist.dry.gteq720lt1440 <- bbw::recode(var = specialist.dry, recode = "6=1;NA=NA;else=0")
    specialist.dry.gteq1440 <- bbw::recode(var = specialist.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    specialist.wet <- as.integer(df$ancnow_pdoc_dist_wet)
    specialist.wet.lt15 <- bbw::recode(var = specialist.wet, recode = "1=1;NA=NA;else=0")
    specialist.wet.gteq15lt60 <- bbw::recode(var = specialist.wet, recode = "2=1;NA=NA;else=0")
    specialist.wet.gteq60lt120 <- bbw::recode(var = specialist.wet, recode = "3=1;NA=NA;else=0")
    specialist.wet.gteq120lt360 <- bbw::recode(var = specialist.wet, recode = "4=1;NA=NA;else=0")
    specialist.wet.gteq360lt720 <- bbw::recode(var = specialist.wet, recode = "5=1;NA=NA;else=0")
    specialist.wet.gteq720lt1440 <- bbw::recode(var = specialist.wet, recode = "6=1;NA=NA;else=0")
    specialist.wet.gteq1440 <- bbw::recode(var = specialist.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
    ...
    specialist <- data.frame(specialist, specialist.where, specialist.home,
                             ...
                             specialist.dry.gteq60lt120, specialist.dry.gteq120lt360,
                             specialist.dry.gteq360lt720, specialist.dry.gteq720lt1440,
                             specialist.dry.gteq1440, specialist.wet,
                             specialist.wet.lt15, specialist.wet.gteq15lt60,
                             specialist.wet.gteq60lt120, specialist.wet.gteq120lt360,
                             specialist.wet.gteq360lt720, specialist.wet.gteq720lt1440,
...
recode_provider_doctor <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    doctor.home <- bbw::recode(var = doctor.where, recodes = "1=1;NA=NA;else=0")
    doctor.gov <- bbw::recode(var = doctor.where, recodes = "2=1;NA=NA;else=0")
    doctor.private <- bbw::recode(var = doctor.where, recodes = "3=1;NA=NA;else=0")
    doctor.srhc <- bbw::recode(var = doctor.where, recodes = "4=1;NA=NA;else=0")
    doctor.village <- bbw::recode(var = doctor.where, recodes = "5=1;NA=NA;else=0")
    doctor.eho <- bbw::recode(var = doctor.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    doctor.dry <- as.integer(df$ancnow_doc_dist_dry)
    doctor.dry.lt15 <- bbw::recode(var = doctor.dry, recode = "1=1;NA=NA;else=0")
    doctor.dry.gteq15lt60 <- bbw::recode(var = doctor.dry, recode = "2=1;NA=NA;else=0")
    doctor.dry.gteq60lt120 <- bbw::recode(var = doctor.dry, recode = "3=1;NA=NA;else=0")
    doctor.dry.gteq120lt360 <- bbw::recode(var = doctor.dry, recode = "4=1;NA=NA;else=0")
    doctor.dry.gteq360lt720 <- bbw::recode(var = doctor.dry, recode = "5=1;NA=NA;else=0")
    doctor.dry.gteq720lt1440 <- bbw::recode(var = doctor.dry, recode = "6=1;NA=NA;else=0")
    doctor.dry.gteq1440 <- bbw::recode(var = doctor.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    doctor.wet <- as.integer(df$ancnow_doc_dist_wet)
    doctor.wet.lt15 <- bbw::recode(var = doctor.wet, recode = "1=1;NA=NA;else=0")
    doctor.wet.gteq15lt60 <- bbw::recode(var = doctor.wet, recode = "2=1;NA=NA;else=0")
    doctor.wet.gteq60lt120 <- bbw::recode(var = doctor.wet, recode = "3=1;NA=NA;else=0")
    doctor.wet.gteq120lt360 <- bbw::recode(var = doctor.wet, recode = "4=1;NA=NA;else=0")
    doctor.wet.gteq360lt720 <- bbw::recode(var = doctor.wet, recode = "5=1;NA=NA;else=0")
    doctor.wet.gteq720lt1440 <- bbw::recode(var = doctor.wet, recode = "6=1;NA=NA;else=0")
    doctor.wet.gteq1440 <- bbw::recode(var = doctor.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_nurse <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    nurse.home <- bbw::recode(var = nurse.where, recodes = "1=1;NA=NA;else=0")
    nurse.gov <- bbw::recode(var = nurse.where, recodes = "2=1;NA=NA;else=0")
    nurse.private <- bbw::recode(var = nurse.where, recodes = "3=1;NA=NA;else=0")
    nurse.srhc <- bbw::recode(var = nurse.where, recodes = "4=1;NA=NA;else=0")
    nurse.village <- bbw::recode(var = nurse.where, recodes = "5=1;NA=NA;else=0")
    nurse.eho <- bbw::recode(var = nurse.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    nurse.dry <- as.integer(df$ancnow_nurs_dist_dry)
    nurse.dry.lt15 <- bbw::recode(var = nurse.dry, recode = "1=1;NA=NA;else=0")
    nurse.dry.gteq15lt60 <- bbw::recode(var = nurse.dry, recode = "2=1;NA=NA;else=0")
    nurse.dry.gteq60lt120 <- bbw::recode(var = nurse.dry, recode = "3=1;NA=NA;else=0")
    nurse.dry.gteq120lt360 <- bbw::recode(var = nurse.dry, recode = "4=1;NA=NA;else=0")
    nurse.dry.gteq360lt720 <- bbw::recode(var = nurse.dry, recode = "5=1;NA=NA;else=0")
    nurse.dry.gteq720lt1440 <- bbw::recode(var = nurse.dry, recode = "6=1;NA=NA;else=0")
    nurse.dry.gteq1440 <- bbw::recode(var = nurse.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    nurse.wet <- as.integer(df$ancnow_nurs_dist_wet)
    nurse.wet.lt15 <- bbw::recode(var = nurse.wet, recode = "1=1;NA=NA;else=0")
    nurse.wet.gteq15lt60 <- bbw::recode(var = nurse.wet, recode = "2=1;NA=NA;else=0")
    nurse.wet.gteq60lt120 <- bbw::recode(var = nurse.wet, recode = "3=1;NA=NA;else=0")
    nurse.wet.gteq120lt360 <- bbw::recode(var = nurse.wet, recode = "4=1;NA=NA;else=0")
    nurse.wet.gteq360lt720 <- bbw::recode(var = nurse.wet, recode = "5=1;NA=NA;else=0")
    nurse.wet.gteq720lt1440 <- bbw::recode(var = nurse.wet, recode = "6=1;NA=NA;else=0")
    nurse.wet.gteq1440 <- bbw::recode(var = nurse.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_ha <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    ha.home <- bbw::recode(var = ha.where, recodes = "1=1;NA=NA;else=0")
    ha.gov <- bbw::recode(var = ha.where, recodes = "2=1;NA=NA;else=0")
    ha.private <- bbw::recode(var = ha.where, recodes = "3=1;NA=NA;else=0")
    ha.srhc <- bbw::recode(var = ha.where, recodes = "4=1;NA=NA;else=0")
    ha.village <- bbw::recode(var = ha.where, recodes = "5=1;NA=NA;else=0")
    ha.eho <- bbw::recode(var = ha.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    ha.dry <- as.integer(df$ancnow_ha_dist_dry)
    ha.dry.lt15 <- bbw::recode(var = ha.dry, recode = "1=1;NA=NA;else=0")
    ha.dry.gteq15lt60 <- bbw::recode(var = ha.dry, recode = "2=1;NA=NA;else=0")
    ha.dry.gteq60lt120 <- bbw::recode(var = ha.dry, recode = "3=1;NA=NA;else=0")
    ha.dry.gteq120lt360 <- bbw::recode(var = ha.dry, recode = "4=1;NA=NA;else=0")
    ha.dry.gteq360lt720 <- bbw::recode(var = ha.dry, recode = "5=1;NA=NA;else=0")
    ha.dry.gteq720lt1440 <- bbw::recode(var = ha.dry, recode = "6=1;NA=NA;else=0")
    ha.dry.gteq1440 <- bbw::recode(var = ha.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    ha.wet <- as.integer(df$ancnow_ha_dist_wet)
    ha.wet.lt15 <- bbw::recode(var = ha.wet, recode = "1=1;NA=NA;else=0")
    ha.wet.gteq15lt60 <- bbw::recode(var = ha.wet, recode = "2=1;NA=NA;else=0")
    ha.wet.gteq60lt120 <- bbw::recode(var = ha.wet, recode = "3=1;NA=NA;else=0")
    ha.wet.gteq120lt360 <- bbw::recode(var = ha.wet, recode = "4=1;NA=NA;else=0")
    ha.wet.gteq360lt720 <- bbw::recode(var = ha.wet, recode = "5=1;NA=NA;else=0")
    ha.wet.gteq720lt1440 <- bbw::recode(var = ha.wet, recode = "6=1;NA=NA;else=0")
    ha.wet.gteq1440 <- bbw::recode(var = ha.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_pdoc <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    pdoc.home <- bbw::recode(var = pdoc.where, recodes = "1=1;NA=NA;else=0")
    pdoc.gov <- bbw::recode(var = pdoc.where, recodes = "2=1;NA=NA;else=0")
    pdoc.private <- bbw::recode(var = pdoc.where, recodes = "3=1;NA=NA;else=0")
    pdoc.srhc <- bbw::recode(var = pdoc.where, recodes = "4=1;NA=NA;else=0")
    pdoc.village <- bbw::recode(var = pdoc.where, recodes = "5=1;NA=NA;else=0")
    pdoc.eho <- bbw::recode(var = pdoc.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    pdoc.dry <- as.integer(df$ancnow_pdoc_dist_dry)
    pdoc.dry.lt15 <- bbw::recode(var = pdoc.dry, recode = "1=1;NA=NA;else=0")
    pdoc.dry.gteq15lt60 <- bbw::recode(var = pdoc.dry, recode = "2=1;NA=NA;else=0")
    pdoc.dry.gteq60lt120 <- bbw::recode(var = pdoc.dry, recode = "3=1;NA=NA;else=0")
    pdoc.dry.gteq120lt360 <- bbw::recode(var = pdoc.dry, recode = "4=1;NA=NA;else=0")
    pdoc.dry.gteq360lt720 <- bbw::recode(var = pdoc.dry, recode = "5=1;NA=NA;else=0")
    pdoc.dry.gteq720lt1440 <- bbw::recode(var = pdoc.dry, recode = "6=1;NA=NA;else=0")
    pdoc.dry.gteq1440 <- bbw::recode(var = pdoc.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    pdoc.wet <- as.integer(df$ancnow_pdoc_dist_wet)
    pdoc.wet.lt15 <- bbw::recode(var = pdoc.wet, recode = "1=1;NA=NA;else=0")
    pdoc.wet.gteq15lt60 <- bbw::recode(var = pdoc.wet, recode = "2=1;NA=NA;else=0")
    pdoc.wet.gteq60lt120 <- bbw::recode(var = pdoc.wet, recode = "3=1;NA=NA;else=0")
    pdoc.wet.gteq120lt360 <- bbw::recode(var = pdoc.wet, recode = "4=1;NA=NA;else=0")
    pdoc.wet.gteq360lt720 <- bbw::recode(var = pdoc.wet, recode = "5=1;NA=NA;else=0")
    pdoc.wet.gteq720lt1440 <- bbw::recode(var = pdoc.wet, recode = "6=1;NA=NA;else=0")
    pdoc.wet.gteq1440 <- bbw::recode(var = pdoc.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
################################################################################
#
#' Function to recode the lady health visitor ANC provider data for the Myanmar MCCT
#' Programme Evaluation survey
#'
#' @param df A data.frame collected for the Myanmar MCCT Programme Evaluation
#'   Study containing antenatal care data for currently pregnant women
...
recode_provider_lhv <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    lhv.home <- bbw::recode(var = lhv.where, recodes = "1=1;NA=NA;else=0")
    lhv.gov <- bbw::recode(var = lhv.where, recodes = "2=1;NA=NA;else=0")
    lhv.private <- bbw::recode(var = lhv.where, recodes = "3=1;NA=NA;else=0")
    lhv.srhc <- bbw::recode(var = lhv.where, recodes = "4=1;NA=NA;else=0")
    lhv.village <- bbw::recode(var = lhv.where, recodes = "5=1;NA=NA;else=0")
    lhv.eho <- bbw::recode(var = lhv.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    lhv.dry <- as.integer(df$ancnow_lhv_dist_dry)
    lhv.dry.lt15 <- bbw::recode(var = lhv.dry, recode = "1=1;NA=NA;else=0")
    lhv.dry.gteq15lt60 <- bbw::recode(var = lhv.dry, recode = "2=1;NA=NA;else=0")
    lhv.dry.gteq60lt120 <- bbw::recode(var = lhv.dry, recode = "3=1;NA=NA;else=0")
    lhv.dry.gteq120lt360 <- bbw::recode(var = lhv.dry, recode = "4=1;NA=NA;else=0")
    lhv.dry.gteq360lt720 <- bbw::recode(var = lhv.dry, recode = "5=1;NA=NA;else=0")
    lhv.dry.gteq720lt1440 <- bbw::recode(var = lhv.dry, recode = "6=1;NA=NA;else=0")
    lhv.dry.gteq1440 <- bbw::recode(var = lhv.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    lhv.wet <- as.integer(df$ancnow_lhv_dist_wet)
    lhv.wet.lt15 <- bbw::recode(var = lhv.wet, recode = "1=1;NA=NA;else=0")
    lhv.wet.gteq15lt60 <- bbw::recode(var = lhv.wet, recode = "2=1;NA=NA;else=0")
    lhv.wet.gteq60lt120 <- bbw::recode(var = lhv.wet, recode = "3=1;NA=NA;else=0")
    lhv.wet.gteq120lt360 <- bbw::recode(var = lhv.wet, recode = "4=1;NA=NA;else=0")
    lhv.wet.gteq360lt720 <- bbw::recode(var = lhv.wet, recode = "5=1;NA=NA;else=0")
    lhv.wet.gteq720lt1440 <- bbw::recode(var = lhv.wet, recode = "6=1;NA=NA;else=0")
    lhv.wet.gteq1440 <- bbw::recode(var = lhv.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_midwife <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    midwife.home <- bbw::recode(var = midwife.where, recodes = "1=1;NA=NA;else=0")
    midwife.gov <- bbw::recode(var = midwife.where, recodes = "2=1;NA=NA;else=0")
    midwife.private <- bbw::recode(var = midwife.where, recodes = "3=1;NA=NA;else=0")
    midwife.srhc <- bbw::recode(var = midwife.where, recodes = "4=1;NA=NA;else=0")
    midwife.village <- bbw::recode(var = midwife.where, recodes = "5=1;NA=NA;else=0")
    midwife.eho <- bbw::recode(var = midwife.where, recodes = "6=1;NA=NA;else=0")
    ## Recode others
    ## Distance dry season
    midwife.dry <- as.integer(df$ancnow_mw_dist_dry)
    midwife.dry.lt15 <- bbw::recode(var = midwife.dry, recode = "1=1;NA=NA;else=0")
    midwife.dry.gteq15lt60 <- bbw::recode(var = midwife.dry, recode = "2=1;NA=NA;else=0")
    midwife.dry.gteq60lt120 <- bbw::recode(var = midwife.dry, recode = "3=1;NA=NA;else=0")
    midwife.dry.gteq120lt360 <- bbw::recode(var = midwife.dry, recode = "4=1;NA=NA;else=0")
    midwife.dry.gteq360lt720 <- bbw::recode(var = midwife.dry, recode = "5=1;NA=NA;else=0")
    midwife.dry.gteq720lt1440 <- bbw::recode(var = midwife.dry, recode = "6=1;NA=NA;else=0")
    midwife.dry.gteq1440 <- bbw::recode(var = midwife.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    midwife.wet <- as.integer(df$ancnow_mw_dist_wet)
    midwife.wet.lt15 <- bbw::recode(var = midwife.wet, recode = "1=1;NA=NA;else=0")
    midwife.wet.gteq15lt60 <- bbw::recode(var = midwife.wet, recode = "2=1;NA=NA;else=0")
    midwife.wet.gteq60lt120 <- bbw::recode(var = midwife.wet, recode = "3=1;NA=NA;else=0")
    midwife.wet.gteq120lt360 <- bbw::recode(var = midwife.wet, recode = "4=1;NA=NA;else=0")
    midwife.wet.gteq360lt720 <- bbw::recode(var = midwife.wet, recode = "5=1;NA=NA;else=0")
    midwife.wet.gteq720lt1440 <- bbw::recode(var = midwife.wet, recode = "6=1;NA=NA;else=0")
    midwife.wet.gteq1440 <- bbw::recode(var = midwife.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
################################################################################
#
#' Function to recode the auxilliary midwife ANC provider data for the Myanmar MCCT
#' Programme Evaluation survey
#'
#' @param df A data.frame collected for the Myanmar MCCT Programme Evaluation
#'   Study containing antenatal care data for currently pregnant women
...
recode_provider_amw <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    amw.dry.lt15 <- bbw::recode(var = amw.dry, recode = "1=1;NA=NA;else=0")
    amw.dry.gteq15lt60 <- bbw::recode(var = amw.dry, recode = "2=1;NA=NA;else=0")
    amw.dry.gteq60lt120 <- bbw::recode(var = amw.dry, recode = "3=1;NA=NA;else=0")
    amw.dry.gteq120lt360 <- bbw::recode(var = amw.dry, recode = "4=1;NA=NA;else=0")
    amw.dry.gteq360lt720 <- bbw::recode(var = amw.dry, recode = "5=1;NA=NA;else=0")
    amw.dry.gteq720lt1440 <- bbw::recode(var = amw.dry, recode = "6=1;NA=NA;else=0")
    amw.dry.gteq1440 <- bbw::recode(var = amw.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    amw.wet <- as.integer(df$ancnow_amw_dist_wet)
    amw.wet.lt15 <- bbw::recode(var = amw.wet, recode = "1=1;NA=NA;else=0")
    amw.wet.gteq15lt60 <- bbw::recode(var = amw.wet, recode = "2=1;NA=NA;else=0")
    amw.wet.gteq60lt120 <- bbw::recode(var = amw.wet, recode = "3=1;NA=NA;else=0")
    amw.wet.gteq120lt360 <- bbw::recode(var = amw.wet, recode = "4=1;NA=NA;else=0")
    amw.wet.gteq360lt720 <- bbw::recode(var = amw.wet, recode = "5=1;NA=NA;else=0")
    amw.wet.gteq720lt1440 <- bbw::recode(var = amw.wet, recode = "6=1;NA=NA;else=0")
    amw.wet.gteq1440 <- bbw::recode(var = amw.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_tba <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    tba.dry.lt15 <- bbw::recode(var = tba.dry, recode = "1=1;NA=NA;else=0")
    tba.dry.gteq15lt60 <- bbw::recode(var = tba.dry, recode = "2=1;NA=NA;else=0")
    tba.dry.gteq60lt120 <- bbw::recode(var = tba.dry, recode = "3=1;NA=NA;else=0")
    tba.dry.gteq120lt360 <- bbw::recode(var = tba.dry, recode = "4=1;NA=NA;else=0")
    tba.dry.gteq360lt720 <- bbw::recode(var = tba.dry, recode = "5=1;NA=NA;else=0")
    tba.dry.gteq720lt1440 <- bbw::recode(var = tba.dry, recode = "6=1;NA=NA;else=0")
    tba.dry.gteq1440 <- bbw::recode(var = tba.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    tba.wet <- as.integer(df$ancnow_tba_dist_wet)
    tba.wet.lt15 <- bbw::recode(var = tba.wet, recode = "1=1;NA=NA;else=0")
    tba.wet.gteq15lt60 <- bbw::recode(var = tba.wet, recode = "2=1;NA=NA;else=0")
    tba.wet.gteq60lt120 <- bbw::recode(var = tba.wet, recode = "3=1;NA=NA;else=0")
    tba.wet.gteq120lt360 <- bbw::recode(var = tba.wet, recode = "4=1;NA=NA;else=0")
    tba.wet.gteq360lt720 <- bbw::recode(var = tba.wet, recode = "5=1;NA=NA;else=0")
    tba.wet.gteq720lt1440 <- bbw::recode(var = tba.wet, recode = "6=1;NA=NA;else=0")
    tba.wet.gteq1440 <- bbw::recode(var = tba.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_chw <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    chw.dry.lt15 <- bbw::recode(var = chw.dry, recode = "1=1;NA=NA;else=0")
    chw.dry.gteq15lt60 <- bbw::recode(var = chw.dry, recode = "2=1;NA=NA;else=0")
    chw.dry.gteq60lt120 <- bbw::recode(var = chw.dry, recode = "3=1;NA=NA;else=0")
    chw.dry.gteq120lt360 <- bbw::recode(var = chw.dry, recode = "4=1;NA=NA;else=0")
    chw.dry.gteq360lt720 <- bbw::recode(var = chw.dry, recode = "5=1;NA=NA;else=0")
    chw.dry.gteq720lt1440 <- bbw::recode(var = chw.dry, recode = "6=1;NA=NA;else=0")
    chw.dry.gteq1440 <- bbw::recode(var = chw.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    chw.wet <- as.integer(df$ancnow_chw_dist_wet)
    chw.wet.lt15 <- bbw::recode(var = chw.wet, recode = "1=1;NA=NA;else=0")
    chw.wet.gteq15lt60 <- bbw::recode(var = chw.wet, recode = "2=1;NA=NA;else=0")
    chw.wet.gteq60lt120 <- bbw::recode(var = chw.wet, recode = "3=1;NA=NA;else=0")
    chw.wet.gteq120lt360 <- bbw::recode(var = chw.wet, recode = "4=1;NA=NA;else=0")
    chw.wet.gteq360lt720 <- bbw::recode(var = chw.wet, recode = "5=1;NA=NA;else=0")
    chw.wet.gteq720lt1440 <- bbw::recode(var = chw.wet, recode = "6=1;NA=NA;else=0")
    chw.wet.gteq1440 <- bbw::recode(var = chw.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_provider_ehw <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    ehw.dry.lt15 <- bbw::recode(var = ehw.dry, recode = "1=1;NA=NA;else=0")
    ehw.dry.gteq15lt60 <- bbw::recode(var = ehw.dry, recode = "2=1;NA=NA;else=0")
    ehw.dry.gteq60lt120 <- bbw::recode(var = ehw.dry, recode = "3=1;NA=NA;else=0")
    ehw.dry.gteq120lt360 <- bbw::recode(var = ehw.dry, recode = "4=1;NA=NA;else=0")
    ehw.dry.gteq360lt720 <- bbw::recode(var = ehw.dry, recode = "5=1;NA=NA;else=0")
    ehw.dry.gteq720lt1440 <- bbw::recode(var = ehw.dry, recode = "6=1;NA=NA;else=0")
    ehw.dry.gteq1440 <- bbw::recode(var = ehw.dry, recode = "7=1;NA=NA;else=0")
    ## Distance wet season
    ehw.wet <- as.integer(df$ancnow_ehw_dist_wet)
    ehw.wet.lt15 <- bbw::recode(var = ehw.wet, recode = "1=1;NA=NA;else=0")
    ehw.wet.gteq15lt60 <- bbw::recode(var = ehw.wet, recode = "2=1;NA=NA;else=0")
    ehw.wet.gteq60lt120 <- bbw::recode(var = ehw.wet, recode = "3=1;NA=NA;else=0")
    ehw.wet.gteq120lt360 <- bbw::recode(var = ehw.wet, recode = "4=1;NA=NA;else=0")
    ehw.wet.gteq360lt720 <- bbw::recode(var = ehw.wet, recode = "5=1;NA=NA;else=0")
    ehw.wet.gteq720lt1440 <- bbw::recode(var = ehw.wet, recode = "6=1;NA=NA;else=0")
    ehw.wet.gteq1440 <- bbw::recode(var = ehw.wet, recode = "7=1;NA=NA;else=0")
    ## Number of visits
...
recode_anc_provider <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    transportCost <- ifelse(is.na(incurCost) | incurCost == 0, NA, transportCost)
    ## Item cost: registration fees
    registrationCost <- as.integer(df$ancnow_costitem.2)
    registrationCost <- ifelse(is.na(incurCost) | incurCost == 0, NA, registrationCost)
    ## Item cost: medicines
    medicineCost <- as.integer(df$ancnow_costitem.3)
    medicineCost <- ifelse(is.na(incurCost) | incurCost == 0, NA, medicineCost)
    ...
    providerCost <- ifelse(is.na(incurCost) | incurCost == 0, NA, providerCost)
    ## Item cost: gifts
    giftCost <- as.integer(df$ancnow_costitem.6)
    giftCost <- ifelse(is.na(incurCost) | incurCost == 0, NA, giftCost)
    ## Borrow money?
  ...
  anc1 <- rowSums(cbind(specialist$specialist.visit,
                  ...
                  na.rm = TRUE)
  anc1 <- bbw::recode(var = anc1, recodes = "1:hi=1;NA=NA;444=NA;448=NA;888=NA;else=0")
  ##
  anc4 <- rowSums(cbind(specialist$specialist.visit,
                        ...
                        ehw$ehw.visit),
                  na.rm = TRUE)
  anc4 <- bbw::recode(var = anc4, recodes = "4:hi=1;NA=NA;444=NA;448=NA;888=NA;1332=NA;else=0")
...
recode_anc_supplementation <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ...
    ifa2a <- bbw::recode(var = ifa2a, recode = "45:hi=NA")
    ifa2[ifa2 == 0] <- NA
...
recode_anc_testing <- function(df, status = NULL) {
  ...
  if(status == "current") {
    ## Tests done
    test1 <- as.integer(df$ancnow_test_yesno)
    test1 <- bbw::recode(var = test1, recodes = "1:4=1;888=1;0=0;999=0;NA=NA")
    ## Hepatitis B
    test2a <- as.integer(df$ancnow_test_yesno.1)
    test2a <- ifelse(is.na(test1), NA, test2a)
    ## Hepatitis C
    test2b <- as.integer(df$ancnow_test_yesno.2)
    test2b <- ifelse(is.na(test1), NA, test2b)
    ## HIV/AIDS
    test2c <- as.integer(df$ancnow_test_yesno.3)
    test2c <- ifelse(is.na(test1), NA, test2c)
    ## Syphillis
    test2d <- as.integer(df$ancnow_test_yesno.4)
    test2d <- ifelse(is.na(test1), NA, test2d)
    ## Code for other tests

    ## Government hospital
    test3a <- as.integer(df$ancnow_test_where.1)
    test3a <- ifelse(is.na(test1), NA, test3a)
    ## EHO clinic
    test3b <- as.integer(df$ancnow_test_where.2)
    test3b <- ifelse(is.na(test1), NA, test3b)
    ## Private doctor/clinic
    test3c <- as.integer(df$ancnow_test_where.3)
    test3c <- ifelse(is.na(test1), NA, test3c)
    ## SRHC/RHC
    test3d <- as.integer(df$ancnow_test_where.4)
    test3d <- ifelse(is.na(test1), NA, test3d)
    ## Routine ANC location in ward/village
    test3e <- as.integer(df$ancnow_test_where.5)
    test3e <- ifelse(is.na(test1), NA, test3e)
    ## Code for other locations

    ## Does test cost?
    test4 <- as.integer(df$ancnow_test_cost)
    test5 <- test4
    test4 <- bbw::recode(var = test4, recodes = "1:hi=1;0=0;NA=NA")
  } else {
    ## Tests done
    test1 <- as.integer(df$ancpast_test_yesno)
    test1 <- bbw::recode(var = test1, recodes = "1:4=1;888=1;0=0;999=0;NA=NA")
    ## Hepatitis B
    test2a <- as.integer(df$ancpast_test_yesno.1)
    test2a <- ifelse(is.na(test1), NA, test2a)
    ## Hepatitis C
    test2b <- as.integer(df$ancpast_test_yesno.2)
    test2b <- ifelse(is.na(test1), NA, test2b)
    ## HIV/AIDS
    test2c <- as.integer(df$ancpast_test_yesno.3)
    test2c <- ifelse(is.na(test1), NA, test2c)
    ## Syphillis
    test2d <- as.integer(df$ancpast_test_yesno.4)
    test2d <- ifelse(is.na(test1), NA, test2d)
    ## Code for other tests

    ## Government hospital
    test3a <- as.integer(df$ancpast_test_where.1)
    test3a <- ifelse(is.na(test1), NA, test3a)
    ## EHO clinic
    test3b <- as.integer(df$ancpast_test_where.2)
    test3b <- ifelse(is.na(test1), NA, test3b)
    ## Private doctor/clinic
    test3c <- as.integer(df$ancpast_test_where.3)
    test3c <- ifelse(is.na(test1), NA, test3c)
    ## SRHC/RHC
    test3d <- as.integer(df$ancpast_test_where.4)
    test3d <- ifelse(is.na(test1), NA, test3d)
    ## Routine ANC location in ward/village
    test3e <- as.integer(df$ancpast_test_where.5)
    test3e <- ifelse(is.na(test1), NA, test3e)
    ## Code for other locations

    ## Does test cost?
    test4 <- as.integer(df$ancpast_test_cost)
    test5 <- test4
    test4 <- bbw::recode(var = test4, recodes = "1:hi=1;0=0;NA=NA")
  }
